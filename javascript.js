...
var frm = ['v3', 'v4'];
var hrf = [['./images/a1.jpg', 'a1.html'], ['./images/a2.jpg', 'a1.html'], ['./images/a3.jpg', 'a1.html']];
function page_a(index) {
...
function fon_a(index) {
  for (i = 0, l = frm.length; i < l; i++) {
    document.querySelector('iframe[name="' + frm[i] + '"]').src = hrf[index][i];
  }
  page_a(index);
}
